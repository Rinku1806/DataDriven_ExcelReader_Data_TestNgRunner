...
public class ExtentManager {
	...
	public static String ForLatest;
	...
	public static ExtentReports getReports() {
		if(reports == null) {// first test
			...
			Date d = new Date();
			ForLatest = d.toString().replaceAll(":", "-");
			System.out.println(d.toString().replaceAll(":", "-"));
			String reportsFolder=d.toString().replaceAll(":", "-") +"//screenshots";
			
		    screenshotFolderPath = System.getProperty("user.dir") +"//ExtentReports//"+reportsFolder;
			String reportFolderPath = System.getProperty("user.dir") +"//ExtentReports//"+d.toString().replaceAll(":", "-");
